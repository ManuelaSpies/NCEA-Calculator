...
test_data_standard = """INSERT INTO standard (standard_id, standard_name, description,  credits, ncea_level, reading, 
                        writing, numeracy, literacy, ue_credits, user)
                        VALUES (NULL, 91367,
...
test_data_result = """INSERT INTO result (entry_id, as_id, grade, user) 
                        VALUES(NULL, 91215, 'M'), (NULL, 91367, 'E', 1);"""
test_data_user = """INSERT INTO user (user_id, username, password)
                    VALUES (NULL, 'testuser1', 'test1'), (NULL, 'testuser1', 'test2');"""
